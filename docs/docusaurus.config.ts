...
const config: Config = {
  ...
  tagline: 'Sistema Multicanal de Agente con UI Web',
          ...
          items: [
            {
              ...
              to: '/docs/01-system-context',
            },
          ],
        },
      ],
      copyright: `Copyright © ${new Date().getFullYear()} Telegram Agent Phase 3. Construido con Docusaurus.`,
    },
    prism: {
